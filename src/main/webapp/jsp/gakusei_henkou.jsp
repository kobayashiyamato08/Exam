...
<body>
	<form action="henkou.jsp" method="get" class="form_gakusei">
		...
		<div class="form_gakusei">
			<label for="ent_year">入学年度:</label> <select name="ent_year">
		...
		<div class="form_gakusei">
			<label for="class_num">クラス番号:</label> <select name="class">
				<option value="" selected>選択してください。</option>
